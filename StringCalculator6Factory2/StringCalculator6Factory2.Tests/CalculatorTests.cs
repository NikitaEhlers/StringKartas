...
using StringCalculator6Factory2;
using System;
...
namespace StringCalculator6Factory2.Tests
{
    [TestFixture]
    public class CalculatorTests
    {
        ...
        public void Add_GivenNegativeNumber_ShouldThrowException()
        {
            ...
            Assert.That(() => calculator.Add("-1,2"), Throws.Exception.Message.Contain("Negatives not allowed"));
        }
        ...
        public void Add_GivenNegativeNumbers_ShouldThrowException()
        {
            ...
            Assert.That(() => calculator.Add("-1,-2,-3"), Throws.Exception.Message.Contain("Negatives not allowed"));
        }
        ...
        [Test]
        public void Add_GivenNumberLargerThousand_ShouldReturnSumWhileIgnoringThousand()
        {
            Calculator calculator = new Calculator();
        ...
        [Test]
        public void Add_GivenMultipleMultiLengthDelimiters_ShouldReturnSumOfSix()
        {
            Calculator calculator = new Calculator();
